...
def escolhaBanco():
    ...
    if escolha == '1':
        bancodeDados = "D:/Programação/Python/GrafosPCV/att48_d.txt"
        return bancodeDados
    if escolha == '2':
        bancodeDados = "D:/Programação/Python/GrafosPCV/dantzig42_d.txt"
        return bancodeDados
    if escolha == '3':
        bancodeDados = "D:/Programação/Python/GrafosPCV/fri26_d.txt"
        return bancodeDados
    if escolha == '4':
        bancodeDados = "D:/Programação/Python/GrafosPCV/gr17_d.txt"
        return bancodeDados
    if escolha == '5':
        bancodeDados = "D:/Programação/Python/GrafosPCV/p01_d.txt"
        return bancodeDados
    else:
        print('')
